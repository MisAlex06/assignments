...
* @Description:Implementation of a binary search on an array of values
* @Params: int* data - data array
*		   int  key  - key to search for
* @Returns: int - positive value = index / negative value = not found
*/
...
/**
* @FunctionName: main
* @Description: Driver for program that creates an array of unique integers and
...
int main() {
	...
	int found = BinarySearch(data,580, size);
